const MainRoutes = {
    ...
    children: [
        ...
        },
        {
            ...
            path: '/tables/datatables/crudtablepromotions',
            component: () => import('@/views/tables/datatables/CrudTablePromotions.vue')
        },
        {
            name: 'CRUD Acceso',
            path: '/tables/datatables/crudtableacceso',
            component: () => import('@/views/tables/datatables/CrudTableAcceso.vue')
        },
        {
            name: 'Punto de venta',
            path: '/app/puntoVenta/puntoventa',
            component: () => import('@/views/apps/puntoVenta/pos2.vue')
        },
        {
            name: 'Inventario',
            path: '/app/inventory/products/create',
            component: () => import('@/views/apps/inventory/products/create/index.vue')
        }
