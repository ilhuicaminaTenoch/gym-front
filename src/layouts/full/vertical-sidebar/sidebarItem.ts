...
const sidebarItem: menu[] = [
    {
        ...
        children: [
            ...
            {
                title: 'Promociones',
                to: '/tables/datatables/crudtablepromotions'
            },
            {
                title: 'Accesos',
                to: '/tables/datatables/crudtableacceso'
            },
            {
                title: 'Punto de venta',
                to: '/app/puntoVenta/puntoventa'
            }
    ...
    {
        title: 'Inventario',
        icon: 'clipboard-check-broken',
        BgColor: 'primary',
        to: '/',
        children: [
            {
                title: 'Productos',
                to: '/app/inventory/products/create'
